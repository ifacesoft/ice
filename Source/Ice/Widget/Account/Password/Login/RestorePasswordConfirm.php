...
use Ice\Action\Security_Password_Login_RestorePasswordConfirm_Submit;
use Ice\DataProvider\Request;

class Account_Password_Login_RestorePasswordConfirm extends Account_Form
{
    /**
     * Widget config
     *
        ...
        $this
            ...
            ->button(
                ...
                [
                    ...
                    'submit' => Security_Password_Login_RestorePasswordConfirm_Submit::class
                ]
            );
    }
}