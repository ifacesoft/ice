...
use Ice\Code\Generator\Render_Smarty as CodeGenerator_Render_Smarty;
...
//        Loader::register('\smartyAutoload');
        ...
        //        $this->_smarty->setCacheDir('/public/www.example.com/smarty/cache');
        //        $this->_smarty->setConfigDir('/public/www.example.com/smarty/configs');
    ...
    public function fetch($template, array $data = [], $layout = null, $templateType = Render::TEMPLATE_TYPE_FILE)
    {
        ...
        $smartyTemplate = $templateType == Render::TEMPLATE_TYPE_STRING
            ...
            : $this->smarty->createTemplate(str_replace(['_', '\\'], '/', $template) . Smarty::TEMPLATE_EXTENSION);
        ...
        try {
            ...
            if (Environment::getInstance()->isDevelopment()) {
                ...
                $smartyTemplate = $this->smarty->createTemplate(
                    'string:' . CodeGenerator_Render_Smarty::getInstance($template)->generate()
                );
                ...
                return $smartyTemplate->fetch(); //todo: May throw exception (see. Twig)
            } else {
