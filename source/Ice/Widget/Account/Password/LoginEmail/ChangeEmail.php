...
use Ice\Action\Security_Password_LoginEmail_ChangeEmail_Submit;
use Ice\DataProvider\Request;
use Ice\Exception\Error;

class Account_Password_LoginEmail_ChangeEmail extends Account_Form
{
...
//            ->setAccountEmailPasswordActionClass(Security_Password_Email_RestorePassword_Submit::class)
            ...
            ->button(
                ...
                [
                    ...
                    'submit' => Security_Password_LoginEmail_ChangeEmail_Submit::class
                ]
            );
