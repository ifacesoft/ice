<ul class="pagination">
    ...
    if (isset($before2)) { ?>
        <li>
            <a onclick="Ice_Paginator.page($(this), '<?= $before2 ?>', '<?= $actionClassName ?>', <?= $params ?>); return false;"><?= $before2 ?></a>
        </li>
    <?php }
    if (isset($before1)) { ?>
        <li>
            <a onclick="Ice_Paginator.page($(this), '<?= $before1 ?>', '<?= $actionClassName ?>', <?= $params ?>); return false;"><?= $before1 ?></a>
        </li>
    <?php } ?>
    <li class="active"><a
    ...
    <?php if (isset($after1)) { ?>
        <li>
            <a onclick="Ice_Paginator.page($(this), '<?= $after1 ?>', '<?= $actionClassName ?>', <?= $params ?>); return false;"><?= $after1 ?></a>
        </li>
    <?php }
    if (isset($after2)) { ?>
        <li>
            <a onclick="Ice_Paginator.page($(this), '<?= $after2 ?>', '<?= $actionClassName ?>', <?= $params ?>); return false;"><?= $after2 ?></a>
        </li>
    <?php }
    ...
    if (isset($last)) { ?>
        <li>
            <a onclick="Ice_Paginator.page($(this), '<?= $last ?>', '<?= $actionClassName ?>', <?= $params ?>); return false;">>>> <?= $last ?></a>
        </li>
    <?php } ?>
</ul>